#ifndef ASSIGNMENT2_RR_ALGORITHM_H
#define ASSIGNMENT2_RR_ALGORITHM_H
 ...
 */
void RR_Algorithm_Add(process *job, int quanta);
 ...
 */
int RR_Algorithm(int quanta);

#endif //ASSIGNMENT2_RR_ALGORITHM_H
